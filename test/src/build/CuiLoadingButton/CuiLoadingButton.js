...
var CuiLoadingButton = function CuiLoadingButton(props) {
  var _classNames;
  ...
  var children = props.children,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["children", "loading", "classes", "className", "themeEngine"]);
  ...
  return _react.default.createElement(_core.Button, (0, _extends2.default)({
    className: className
  }, other), children, loading && _react.default.createElement(SpinnerAdornment, null));
};
